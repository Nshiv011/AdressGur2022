...
<Accordion defaultActiveKey={`2`} >
  ...
  <h3 className="text-gray-800 text-lg ">  1. Personal Information You Choose to Provide</h3>
    ...
    You can generally visit the Site without revealing any personally identifiable information about yourself, and you do not need an account to post listings, browse listings, or respond to listings. If you choose to create an account and/or use our Services, we may collect personally identifiable information that you submit such as your name, contact data (address, email address, phone number) and other similar information. Likewise, we may also collect additional personally identifiable information that you voluntarily include in your listings or transmit with your communications to us.
The information that you provide when you post a listing is displayed in public areas and available to all visitors. Any information that is disclosed in these areas becomes public information, so please exercise caution. We also provide you with the option to submit pictures and/or a description of your item or service. When you post your listing on the Site, the description and pictures are displayed on the site and accessible to visitors on the Site. If you provide personal information to a buyer or seller (either directly or by circumventing our messaging system), we have no control over how that information might be used by that individual. We recommend using our messaging system for any communications between you and potential buyers and sellers. 
    </p>
    </Accordion.Body>
  </Accordion.Item>
</Accordion>  
...
<Accordion defaultActiveKey={`2`} >
  <Accordion.Item eventKey="2">
    <Accordion.Header>
  <h3 className="text-gray-800 text-lg "> 2. Web Site Use Information</h3>
         </Accordion.Header>
    <Accordion.Body>
    <p className="text-gray-700 text-sm ">
...
<br/><br/>
How Do We Use Information We Collect from Cookies?<br/>
...
<br/><br/><b>Sharing Information with Third Parties</b><br/>
...
<br/><br/><b>Notice of New Services and Changes</b><br/>
Occasionally, we may also use the information we collect to notify you about important changes to the Site, new services and special offers we think you will find valuable. As our customer, you will be given the opportunity to notify us of your desire not to receive these offers. HOW DO WE PROTECT YOUR INFORMATION?
...
<br/><br/><b>Certain Disclosures</b><br/>
